...
- **`monitor-estado.md`** — dashboard/JSON de estado en tiempo real (Ollama, Qdrant, Open WebUI, GPU, discos, backup, etc.), corriendo todo el tiempo como un servicio más, alcanzable local, por Tailscale, o por internet (agregando una segunda ruta al mismo túnel de Cloudflare).

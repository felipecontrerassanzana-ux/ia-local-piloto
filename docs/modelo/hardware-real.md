...
| Almacenamiento | NVMe ~500GB + HDD 1TB (dos discos separados — ver `../arquitectura/almacenamiento.md` para cómo repartir qué va en cada uno) |
...
- **Sí importa para la continuidad del servicio** (ver `../arquitectura/arquitectura-piloto.md`): si alguien más reinicia o apaga el equipo, el piloto se cae con él — es una limitación real de que no sea una máquina dedicada, a tener en cuenta antes de depender de que quede "siempre disponible".

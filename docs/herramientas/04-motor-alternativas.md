...
**Open WebUI** se suma de todas formas como interfaz web — no depende de si el motor es Ollama o LocalAI, y es la pieza que se expone por el acceso remoto (ver `../operacion/02-acceso-remoto.md`).

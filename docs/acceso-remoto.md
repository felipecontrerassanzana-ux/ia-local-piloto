...
**Qué exponer:** la interfaz de Open WebUI (ver `motor-alternativas.md`), no el puerto crudo de Ollama — con autenticación (usuario/clave) activada en Open WebUI antes de dejar el túnel activo de forma permanente.

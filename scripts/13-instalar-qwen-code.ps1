...
.SINOPSIS
  ...
  Ver docs/herramientas/herramientas-trabajo.md § "extensión Qwen para VS Code".
...
if (Test-Path $configPath) {
    ...
    Write-Host "Agregar a mano el bloque 'modelProviders' de docs/herramientas/herramientas-trabajo.md si no está." -ForegroundColor Yellow
} else {
    $config = @{

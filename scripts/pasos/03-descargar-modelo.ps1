<#
.SINOPSIS
  Descarga Qwen 2.5 Coder 7B en dos cuantizaciones para comparar (ver docs/02-modelo/02-modelo-elegido.md),
  el modelo de visión para revisión de diseño (ver docs/01-arquitectura/02-capa-diseno.md), y los embeddings del RAG.
...
Write-Host "(NO se instala como librería de Python aparte — ver docs/01-arquitectura/03-docker-y-recursos.md, por qué)." -ForegroundColor Cyan
ollama pull bge-m3

Write-Host ""
Write-Host "Descargando qwen3-vl:4b (~3.3GB) — revisor visual de diseño, ver docs/01-arquitectura/02-capa-diseno.md" -ForegroundColor Cyan

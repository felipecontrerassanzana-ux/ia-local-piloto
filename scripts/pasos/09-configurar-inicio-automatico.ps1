...
.SINOPSIS
  ...
  sin necesitar que alguien inicie sesión. Ver docs/operacion/01-mantenimiento.md §1.
#>
...
# ver docs/arquitectura/03-docker-y-recursos.md) — se revisan como tal, no como contenedores.

...
.SINOPSIS
  ...
  sin necesitar que alguien inicie sesión. Ver docs/06-operacion/01-mantenimiento.md §1.
#>
...
# ver docs/01-arquitectura/03-docker-y-recursos.md) — se revisan como tal, no como contenedores.

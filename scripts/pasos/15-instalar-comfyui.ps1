...
.SINOPSIS
  ...
  diseno (ver docs/arquitectura/02-capa-diseno.md). Se instala en el NVMe (ver docs/arquitectura/04-almacenamiento.md).
  ...
  Open WebUI): el diseno de este piloto protege la VRAM del modelo de codigo (ver docs/arquitectura/02-capa-diseno.md)
...
Write-Host "API para uso programático (parte de la Skill de docs/arquitectura/02-capa-diseno.md): http://localhost:8188/prompt" -ForegroundColor White

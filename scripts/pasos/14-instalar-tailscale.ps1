...
.SINOPSIS
  ...
  de casa) sin exponer nada a internet público. Ver docs/herramientas/02-qwen-code-a-fondo.md § "Escenario C1".
...
Write-Host "Esa IP es la que va en 'baseUrl' de ~/.qwen/settings.json cuando Qwen Code corre en otro dispositivo (ver docs/herramientas/02-qwen-code-a-fondo.md)." -ForegroundColor Cyan
Write-Host ""

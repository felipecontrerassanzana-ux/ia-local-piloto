...
.SINOPSIS
  ...
  Ver docs/pruebas/02-pruebas-rendimiento.md para qué mide cada prueba y cómo interpretar los resultados.
...
.PARAMETER Modelo
  Tag del modelo a probar. Por defecto el recomendado en docs/modelo/02-modelo-elegido.md.
#>
...
Write-Host ""
Write-Host "--- Prueba 3: Rampa de contexto (verifica el límite real, ver docs/modelo/02-modelo-elegido.md) ---" -ForegroundColor Yellow

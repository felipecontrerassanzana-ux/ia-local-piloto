...
.SINOPSIS
  ...
  Ver docs/arquitectura/almacenamiento.md y docs/herramientas/herramientas-trabajo.md para el porqué de cada valor.
  ...
  ver docs/arquitectura/capa-diseno.md), cada modelo se lee del disco varias veces por sesión de trabajo, no
...
.PARAMETER ContextoTokens
  ...
  Qwen 2.5 Coder 7B en esta GPU (ver docs/modelo/modelo-elegido.md) — pero ver también la nota sobre
...
.PARAMETER PermitirRed
  ...
  docs/herramientas/qwen-code-a-fondo.md (Qwen Code/Goose desde otro dispositivo). No activar si no se va a

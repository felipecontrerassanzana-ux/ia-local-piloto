...
.SINOPSIS
  ...
  Ver docs/01-arquitectura/03-docker-y-recursos.md. Requiere Python (scripts/pasos/12-instalar-herramientas-dev.ps1).
  ...
  conectados. Ver docs/07-referencia/05-open-webui.md para el detalle completo del hallazgo.
#>
...
# --- Conectar Open WebUI a Qdrant y BGE-M3 (ver docs/07-referencia/05-open-webui.md) ---
...
Write-Host "  (comportamiento por defecto de Open WebUI, ver docs/06-operacion/02-acceso-remoto.md) — no dejar esto para después." -ForegroundColor Yellow
Write-Host ""

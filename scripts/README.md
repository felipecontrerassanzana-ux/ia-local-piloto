...
| 02 | `02-configurar-ollama.bat` | Configura contexto largo y mueve modelos al **NVMe** (corregido 2026-08-27, ver `../docs/arquitectura/almacenamiento.md`). Con `-PermitirRed`, además pone `OLLAMA_HOST=0.0.0.0` (necesario para conectar Qwen Code/Goose remotos, ver script 14) | Confirmar la letra del NVMe (te la pide al correrlo) |
...
| 05 | `05-instalar-docker.bat` | **Opcional/respaldo** — instala Docker Desktop solo si algo nativo (06/07) da problemas. Ver `../docs/arquitectura/docker-y-recursos.md` | No, y normalmente no hace falta |

...
.SINOPSIS
  ...
  archivo -- ver docs/04-instalacion/01-plan-instalacion.md, ej. 07 necesita 12 primero aunque el
  ...
  ver docs/04-instalacion/02-aprendizaje-scripts.md), en el orden correcto, con verificación
